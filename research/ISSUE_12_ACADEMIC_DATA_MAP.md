...
## 10. Foundational Concepts: HTML, JSON, SQL, and Scraping

This section provides a technical primer on the core building blocks of our academic data ingestion pipeline: **HTML Parsing**, **JSON Data Structures**, and **SQL Relational Databases**.

### HTML & Web Scraping (How We Get the Data)
...
### JSON: JavaScript Object Notation (How We Structure the Data)
...
### SQL: Structured Query Language (How We Save the Data)
